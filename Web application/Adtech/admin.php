...
<div class="extra">
	<div id="page_3">
	  <div class="main zerogrid">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
           <center>
<div style="font-family:verdana;padding:100px;border-radius:10px;border:7px solid #ca6509; left:10px;width:300px;height:300px;">
  <form  action="" method="post" enctype="multipart/form-data" >
  <div class="fileUpload btn btn-primary">
  <input type="file" class="fileUpload" name="files[]" multiple accept="AllFiles/*"   /></div>
  <br><br><br><br><br><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" class="classname" value="Upload">
</form>
...
foreach ($_FILES['files']['name'] as $f => $name) { 
 ...
 $output=exec("zopfli $name ");
  $File = "downloadfile.txt"; 
 $Handle = fopen($File, 'w');
 $data=$name.'.gz';
 echo $name;
 fwrite($Handle,$data);
 //echo "<a href='$name.gz'>Download</a>";
...
<div class="extra">
	<div id="page_4">
		<div class="main zerogrid">
			...
			<header>
				...
				<nav>
					<ul class="menu">
						...
						<li class="active"><a href="#page_4">ClientView</a></li>
						<li><a href="#page_5">ChatRoom</a></li>
						<li><a href="#page_6">Contacts</a></li>
					</ul>
				</nav>
            ...
            <br><br>
			<center>
<div style="font-family:verdana;padding:100px;border-radius:10px;border:7px solid green; left:10px;width:300px;height:300px;">IP Address :
  <input type="text" class="input" id="ipaddress" name="ipaddress"/><br><br>
Port Number:
<input type="text" id="portno" class="input" name="portno" style="height:20 px;"/><br><br>
